...
const en: Dict = {
  ...
  "kpi.requiresReview": "Requires Review",
  "kpi.inProgress": "In Progress",
  "kpi.complete": "Complete",
  "kpi.completedByAgent": "Completed by Agent",
  "kpi.totalInMarket": "Total in market",
  "kpi.openPlacements": "Open placements",
  "kpi.premiumInMarket": "Premium in market",
  "kpi.quoteToBind": "Quote-to-bind rate",
  "kpi.awaitingCarrier": "Awaiting carrier",
  "kpi.medianTurnaround": "Median quote turnaround",
  "kpi.runs24h": "Runs, last 24h",
  "kpi.completionRate": "Completion rate",
  "kpi.failed24h": "Failed, last 24h",
  "kpi.medianDuration": "Median duration",
  "review.approve": "Approve",
  "review.reject": "Reject",
  "review.escalate": "Escalate",
  "review.assignToMe": "Assign to me",
  "review.reopen": "Reopen",
  "review.assignedToYou": "Assigned to you",
  "review.noDecideRights": "Your role can view this item but not decide it.",
  "review.reasonRequired": "A reason is required.",
  "review.decisionHistory": "Decision history",
  "table.type": "Type",
  "table.status": "Status",
...
const id: Dict = {
  "status.requiresReview": "Perlu Ditinjau",
  "status.inReview": "Sedang Ditinjau",
  "status.completed": "Selesai",
  "status.succeeded": "Berhasil",
  "status.failed": "Gagal",
  "status.pending": "Menunggu",
  "status.awaitingReview": "Menunggu tinjauan",
  "status.bound": "Terikat",
  "status.declined": "Ditolak",
  "kpi.requiresReview": "Perlu Ditinjau",
  "kpi.inProgress": "Sedang Berjalan",
  "kpi.complete": "Selesai",
  "kpi.completedByAgent": "Diselesaikan oleh Agen",
  "kpi.totalInMarket": "Total di pasar",
  "kpi.openPlacements": "Penempatan terbuka",
  "kpi.premiumInMarket": "Premi di pasar",
  "kpi.quoteToBind": "Rasio kutipan ke pengikatan",
  "kpi.awaitingCarrier": "Menunggu penanggung",
  "kpi.medianTurnaround": "Median waktu kutipan",
  "kpi.runs24h": "Eksekusi, 24 jam terakhir",
  "kpi.completionRate": "Tingkat penyelesaian",
  "kpi.failed24h": "Gagal, 24 jam terakhir",
  "kpi.medianDuration": "Durasi median",
  "review.approve": "Setujui",
  "review.reject": "Tolak",
  "review.escalate": "Eskalasi",
  "review.assignToMe": "Tugaskan ke saya",
  "review.reopen": "Buka kembali",
  "review.assignedToYou": "Ditugaskan kepada Anda",
  "review.noDecideRights": "Peran Anda dapat melihat item ini tetapi tidak memutuskannya.",
  "review.reasonRequired": "Alasan wajib diisi.",
  "review.decisionHistory": "Riwayat keputusan",
  "table.type": "Jenis",
  "table.status": "Status",
  "table.reviewer": "Peninjau",
...
const ms: Dict = {
  "status.requiresReview": "Perlu Semakan",
  "status.inReview": "Dalam Semakan",
  "status.completed": "Selesai",
  "status.succeeded": "Berjaya",
  "status.failed": "Gagal",
  "status.pending": "Menunggu",
  "status.awaitingReview": "Menunggu semakan",
  "status.bound": "Terikat",
  "status.declined": "Ditolak",
  "kpi.requiresReview": "Perlu Semakan",
  "kpi.inProgress": "Sedang Berjalan",
  "kpi.complete": "Selesai",
  "kpi.completedByAgent": "Diselesaikan oleh Ejen",
  "kpi.totalInMarket": "Jumlah di pasaran",
  "kpi.openPlacements": "Penempatan terbuka",
  "kpi.premiumInMarket": "Premium di pasaran",
  "kpi.quoteToBind": "Kadar sebut harga ke ikatan",
  "kpi.awaitingCarrier": "Menunggu penanggung",
  "kpi.medianTurnaround": "Median masa sebut harga",
  "kpi.runs24h": "Larian, 24 jam lepas",
  "kpi.completionRate": "Kadar penyelesaian",
  "kpi.failed24h": "Gagal, 24 jam lepas",
  "kpi.medianDuration": "Tempoh median",
  "review.approve": "Luluskan",
  "review.reject": "Tolak",
  "review.escalate": "Tingkatkan",
  "review.assignToMe": "Tugaskan kepada saya",
  "review.reopen": "Buka semula",
  "review.assignedToYou": "Ditugaskan kepada anda",
  "review.noDecideRights": "Peranan anda boleh melihat item ini tetapi tidak memutuskannya.",
  "review.reasonRequired": "Sebab diperlukan.",
  "review.decisionHistory": "Sejarah keputusan",
  "table.type": "Jenis",
  "table.status": "Status",
  "table.reviewer": "Penyemak",
  "table.duration": "Tempoh",
...
const th: Dict = {
  "status.requiresReview": "ต้องตรวจสอบ",
  "status.inReview": "กำลังตรวจสอบ",
  "status.completed": "เสร็จสิ้น",
  "status.succeeded": "สำเร็จ",
  "status.failed": "ล้มเหลว",
  "status.pending": "รอดำเนินการ",
  "status.awaitingReview": "รอการตรวจสอบ",
  "status.bound": "ผูกพันแล้ว",
  "status.declined": "ปฏิเสธ",
  "kpi.requiresReview": "ต้องตรวจสอบ",
  "kpi.inProgress": "กำลังดำเนินการ",
  "kpi.complete": "เสร็จสิ้น",
  "kpi.completedByAgent": "ดำเนินการโดยเอเจนต์",
  "kpi.totalInMarket": "ทั้งหมดในตลาด",
  "kpi.openPlacements": "การจัดวางที่เปิดอยู่",
  "kpi.premiumInMarket": "เบี้ยประกันในตลาด",
  "kpi.quoteToBind": "อัตราใบเสนอราคาสู่การผูกพัน",
  "kpi.awaitingCarrier": "รอบริษัทประกัน",
  "kpi.medianTurnaround": "ระยะเวลาเสนอราคาเฉลี่ย",
  "kpi.runs24h": "การรัน 24 ชม.ล่าสุด",
  "kpi.completionRate": "อัตราความสำเร็จ",
  "kpi.failed24h": "ล้มเหลว 24 ชม.ล่าสุด",
  "kpi.medianDuration": "ระยะเวลาเฉลี่ย",
  "review.approve": "อนุมัติ",
  "review.reject": "ปฏิเสธ",
  "review.escalate": "ส่งต่อระดับสูง",
  "review.assignToMe": "มอบหมายให้ฉัน",
  "review.reopen": "เปิดใหม่",
  "review.assignedToYou": "มอบหมายให้คุณ",
  "review.noDecideRights": "บทบาทของคุณดูรายการนี้ได้แต่ตัดสินไม่ได้",
  "review.reasonRequired": "ต้องระบุเหตุผล",
  "review.decisionHistory": "ประวัติการตัดสิน",
  "table.type": "ประเภท",
  "table.status": "สถานะ",
  "table.reviewer": "ผู้ตรวจสอบ",
...
const vi: Dict = {
  "status.requiresReview": "Cần xem xét",
  "status.inReview": "Đang xem xét",
  "status.completed": "Hoàn tất",
  "status.succeeded": "Thành công",
  "status.failed": "Thất bại",
  "status.pending": "Đang chờ",
  "status.awaitingReview": "Chờ xem xét",
  "status.bound": "Đã ký kết",
  "status.declined": "Từ chối",
  "kpi.requiresReview": "Cần xem xét",
  "kpi.inProgress": "Đang xử lý",
  "kpi.complete": "Hoàn tất",
  "kpi.completedByAgent": "Do tác nhân hoàn tất",
  "kpi.totalInMarket": "Tổng trong thị trường",
  "kpi.openPlacements": "Hồ sơ đang mở",
  "kpi.premiumInMarket": "Phí bảo hiểm trong thị trường",
  "kpi.quoteToBind": "Tỷ lệ báo giá thành hợp đồng",
  "kpi.awaitingCarrier": "Chờ nhà bảo hiểm",
  "kpi.medianTurnaround": "Thời gian báo giá trung vị",
  "kpi.runs24h": "Lượt chạy, 24 giờ qua",
  "kpi.completionRate": "Tỷ lệ hoàn tất",
  "kpi.failed24h": "Thất bại, 24 giờ qua",
  "kpi.medianDuration": "Thời lượng trung vị",
  "review.approve": "Phê duyệt",
  "review.reject": "Từ chối",
  "review.escalate": "Chuyển cấp trên",
  "review.assignToMe": "Giao cho tôi",
  "review.reopen": "Mở lại",
  "review.assignedToYou": "Được giao cho bạn",
  "review.noDecideRights": "Vai trò của bạn có thể xem mục này nhưng không thể quyết định.",
  "review.reasonRequired": "Bắt buộc nêu lý do.",
  "review.decisionHistory": "Lịch sử quyết định",
  "table.type": "Loại",
  "table.status": "Trạng thái",
  "table.reviewer": "Người xem xét",
...
const fil: Dict = {
  "status.requiresReview": "Kailangang Suriin",
  "status.inReview": "Sinusuri",
  "status.completed": "Tapos na",
  "status.succeeded": "Nagtagumpay",
  "status.failed": "Nabigo",
  "status.pending": "Nakabinbin",
  "status.awaitingReview": "Naghihintay ng pagsusuri",
  "status.bound": "Naitali",
  "status.declined": "Tinanggihan",
  "kpi.requiresReview": "Kailangang Suriin",
  "kpi.inProgress": "Isinasagawa",
  "kpi.complete": "Kumpleto",
  "kpi.completedByAgent": "Tinapos ng Ahente",
  "kpi.totalInMarket": "Kabuuan sa merkado",
  "kpi.openPlacements": "Bukas na placement",
  "kpi.premiumInMarket": "Premium sa merkado",
  "kpi.quoteToBind": "Rate ng quote papuntang bind",
  "kpi.awaitingCarrier": "Naghihintay sa carrier",
  "kpi.medianTurnaround": "Median na turnaround ng quote",
  "kpi.runs24h": "Runs, huling 24h",
  "kpi.completionRate": "Rate ng pagkumpleto",
  "kpi.failed24h": "Nabigo, huling 24h",
  "kpi.medianDuration": "Median na tagal",
  "review.approve": "Aprubahan",
  "review.reject": "Tanggihan",
  "review.escalate": "I-escalate",
  "review.assignToMe": "Italaga sa akin",
  "review.reopen": "Buksang muli",
  "review.assignedToYou": "Nakatalaga sa iyo",
  "review.noDecideRights": "Makikita ng iyong role ang item na ito ngunit hindi ito madedesisyunan.",
  "review.reasonRequired": "Kailangan ng dahilan.",
  "review.decisionHistory": "Kasaysayan ng desisyon",
  "table.type": "Uri",
  "table.status": "Katayuan",
  "table.reviewer": "Tagasuri",
  "table.duration": "Tagal",
  "table.created": "Nilikha",
  "table.name": "Pangalan",
  "nav.copilot": "Copilot",
